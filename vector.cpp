...
void Vector::pushBack(const ValueType& value)
{
    if (_size == _capacity)
    {
    	...
    	else
    	{
        	...
        	ValueType* ndata = new ValueType[_capacity];
        	std::memcpy(ndata, _data, _size * sizeof(ValueType));
        	delete[] _data;
        	_data = ndata;
        	ndata = nullptr;
    	}
...
{
    ValueType* ndata = new ValueType[_size - (endPos - beginPos)];
    size_t counter = 0;
...
void Vector::reserve(size_t capacity)
{
    ...
    {
        ValueType* ndata = new ValueType[capacity];
        std::memcpy(ndata, _data, _size * sizeof(ValueType));
        delete[] _data;
        _data = ndata;
        _capacity = capacity;
...
void Vector::shrinkToFit()
{
    ...
    ValueType* ndata = new ValueType[_size];
    std::memcpy(ndata, _data, _size * sizeof(ValueType));
    delete[] _data;
    _data = ndata;
    _capacity = _size;
